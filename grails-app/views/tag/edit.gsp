...
<body>
	<g:if test="${session.getAttribute('role').equals(Role.ADMIN) }">
		<a href="#edit-taggingOfUser" class="skip" tabindex="-1"><g:message
				code="default.link.skip.label" default="Skip to content&hellip;" /></a>
		<div id="edit-taggingOfUser" class="content scaffold-edit" role="main">
			<h1>
			...
			<g:form method="post">
				...
				<g:hiddenField name="version"
					value="${taggingOfUserInstance?.version}" />
				<fieldset class="form">

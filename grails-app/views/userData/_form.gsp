...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'password', 'error')} ">
	...
	<g:passwordField name="password" maxlength="8" value="${userInstance?.password}" id="password"/>
</div>
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'password', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'role', 'error')} ">
	...
	<g:select id="role" name="role" from="${Role}" value="${userInstance?.role}" noSelection="['null': '']"/>
</div>
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'profile', 'error')} ">
	...
	<g:select id="profile" name="profile.id" from="${com.getsocio.Profile.list()}" optionKey="id" value="${userInstance?.profile?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'following', 'error')} ">
	...
	<g:select name="following" from="${com.getsocio.User.list()}" multiple="multiple" optionKey="id" size="5" value="${userInstance?.following*.id}" class="many-to-many" noSelection="['null': '']"/>
</div>

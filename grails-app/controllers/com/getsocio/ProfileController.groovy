...
class ProfileController {
    ...
    def save() {
        ...
        if (params?.photo?.getBytes().toString().equals("[]")) {
            ...
            if (defaultImage) {
                profileInstance.photo = defaultImage.getBytes()
    ...
    def update(Long id, Long version) {
        ...
        if (params.photo.getBytes().toString().equals("[]")) {
            ...
            profileInstance.fullName = params?.fullName
            profileInstance.bio = params?.bio
            profileInstance.homepage = params?.homepage
            profileInstance.country = params?.country
            profileInstance.timezone = params?.timezone
            profileInstance.email = params?.email
            profileInstance.dateOfBirth = params?.dateOfBirth
        } else {
    ...
    /**
     * function to show profile of other user through wall
     * @return map containing profile,follower and isFollowing flag
     */
    def showProfile() {
